...
if (process.env.NODE_ENV == 'production') {
  mongoUrl = 'mongodb://db:27017/nodeSoundscape';
} else { 
  mongoUrl = 'mongodb://localhost:27017/nodeSoundscape';
}
...
const artistRouter = require('./src/routes/artistRoutes')(mongoUrl);
const eventRouter = require('./src/routes/eventRoutes')(mongoUrl);
